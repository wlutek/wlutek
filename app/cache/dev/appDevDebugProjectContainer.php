...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'locale.locale_listener' => 'getLocale_LocaleListenerService',
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('locale.locale_listener', 'AppBundle\\EventListener\\LocaleListener');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'wojtek', 'user' => 'root', 'password' => 123, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7346ac2a968774dab9ecb473598f74910401976a9562ca1dfc0d95eeb6bc8ad1');
    ...
    /**
     * Gets the 'locale.locale_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\EventListener\LocaleListener A AppBundle\EventListener\LocaleListener instance.
     */
    protected function getLocale_LocaleListenerService()
    {
        return $this->services['locale.locale_listener'] = new \AppBundle\EventListener\LocaleListener('en');
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'/src/AppBundle/Resources/translations/messages.en.yml'), 'en', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'/src/AppBundle/Resources/translations/messages.pl.yml'), 'pl', 'messages');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('54b42a7a2788f')), true);
